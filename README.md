...
Данный проект в первую очередь направлен на построение фильтров коллекций динамическим способом, как правило вне среды dotNET, например с помощью JavaScipt.
